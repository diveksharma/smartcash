        ...
        <main>
          ...
          <div class="bg-warm-gray-50">
            <div class="py-3 pt-10">
              <div class="z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
                <h1
                  class="
                    text-4xl
                    sm:ml-10
            ...
            <div class="bg-white">
              <div class="max-w-7xl mx-auto py-16 px-4 sm:py-16 sm:px-6 lg:px-8">
                <div class="relative bg-white shadow-lg duration-500 ease-in-out hover:shadow-2xl">
                  <h2 class="sr-only">Kontakt info</h2>

                  <div class="grid grid-cols-1 lg:grid-cols-3">
                    <!-- Contact information -->
                    <div class="relative overflow-hidden py-10 px-6 bg-gradient-to-b from-pink-300 via-purple-400 to-indigo-400 sm:px-10 xl:p-12">
                      ...
                      <h3 class="text-lg font-medium text-white">Kontakt info</h3>
                      <p class="mt-6 text-base text-indigo-50 max-w-3xl">Kiselgatan 19
                                                                            Norrköping, 60223
                                                                            Sverige</p>
          ...
          <!--                 <MailIcon class="flex-shrink-0 w-6 h-6 text-indigo-200" aria-hidden="true" /> -->
                    ...
                    <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                      <h3 class="text-lg font-medium text-gray-900">Skicka ett meddelande</h3>
                      <form action="#" method="POST" @submit.prevent="submitContactForm()" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                        <div>
                          <label for="first-name" class="block text-sm font-medium text-gray-900">First name</label>
                          <div class="mt-1">
                            <input type="text" name="first-name" id="first-name" autocomplete="given-name" required v-model="fields.name" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md" />
                          </div>
                        </div>
                        <div>
                          <label for="last-name" class="block text-sm font-medium text-gray-900">Last name</label>
                          <div class="mt-1">
                            <input type="text" name="last-name" id="last-name" autocomplete="family-name" required v-model="fields.lastname" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md" />
                          </div>
                        </div>
                        <div>
                          <label for="email" class="block text-sm font-medium text-gray-900">Email</label>
                          <div class="mt-1">
                            <input id="email" name="email" type="email" autocomplete="email" required v-model="fields.email" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md" />
                          </div>
                        </div>
                        <div>
                          <div class="flex justify-between">
                            <label for="phone" class="block text-sm font-medium text-gray-900">Phone</label>
                            <span id="phone-optional" class="text-sm text-gray-500"></span>
                          </div>
                          <div class="mt-1">
                            <input type="text" name="phone" id="phone" autocomplete="tel" required v-model="fields.phone" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md" aria-describedby="phone-optional" />
                          </div>
                        </div>
                        <div class="sm:col-span-2">
                          <div class="flex justify-between">
                            <label for="message" class="block text-sm font-medium text-gray-900">Message</label>
                            <span id="message-max" class="text-sm text-gray-500"></span>
                          </div>
                          <div class="mt-1">
                            <textarea id="message" name="message" rows="4" v-model="fields.message" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:ring-indigo-500 focus:border-indigo-500 border border-gray-300 rounded-md" aria-describedby="message-max" />
                          </div>
                        </div>
                        <div class="sm:col-span-2 sm:flex sm:justify-end">
                          <button type="submit" class="mt-2 w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-pink-400 transition duration-500 ease-in-out hover:bg-pink-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:w-auto">
                            Skicka
                          </button>
              ...
              <div class="max-w-7xl mx-auto py-12 px-4 text-center sm:px-6 lg:px-8 lg:py-2">
                <div class="space-y-12">
                  <div class="space-y-5 sm:mx-auto sm:max-w-xl sm:space-y-4 lg:max-w-5xl">
                    <h2 class="text-3xl font-extrabold tracking-tight sm:text-4xl">Smart Cash Team</h2>
                      ...
                      <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                          <div class="text-lg leading-6 font-medium space-y-1">
                            <h3>{{ person.name }}</h3>
                            <p class="text-gray-600 text-sm">{{ person.mail }}</p>
                            <p class="bg-clip-text text-transparent bg-gradient-to-b from-purple-500 to-indigo-500">{{ person.role }}</p>
                          </div>
<!--                           <ul role="list" class="flex justify-center space-x-5">
                            <li>
                              <a :href="person.linkedinUrl" class="text-indigo-200 hover:text-indigo-100" href="#">
                                <span class="sr-only">Instagram</span>
                                <svg class="h-7 w-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                  <path fill-rule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.067.06 1.407.06 4.123v.08c0 2.643-.012 2.987-.06 4.043-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.067.048-1.407.06-4.123.06h-.08c-2.643 0-2.987-.012-4.043-.06-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.047-1.024-.06-1.379-.06-3.808v-.63c0-2.43.013-2.784.06-3.808.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772A4.902 4.902 0 015.45 2.525c.636-.247 1.363-.416 2.427-.465C8.901 2.013 9.256 2 11.685 2h.63zm-.081 1.802h-.468c-2.456 0-2.784.011-3.807.058-.975.045-1.504.207-1.857.344-.467.182-.8.398-1.15.748-.35.35-.566.683-.748 1.15-.137.353-.3.882-.344 1.857-.047 1.023-.058 1.351-.058 3.807v.468c0 2.456.011 2.784.058 3.807.045.975.207 1.504.344 1.857.182.466.399.8.748 1.15.35.35.683.566 1.15.748.353.137.882.3 1.857.344 1.054.048 1.37.058 4.041.058h.08c2.597 0 2.917-.01 3.96-.058.976-.045 1.505-.207 1.858-.344.466-.182.8-.398 1.15-.748.35-.35.566-.683.748-1.15.137-.353.3-.882.344-1.857.048-1.055.058-1.37.058-4.041v-.08c0-2.597-.01-2.917-.058-3.96-.045-.976-.207-1.505-.344-1.858a3.097 3.097 0 00-.748-1.15 3.098 3.098 0 00-1.15-.748c-.353-.137-.882-.3-1.857-.344-1.023-.047-1.351-.058-3.807-.058zM12 6.865a5.135 5.135 0 110 10.27 5.135 5.135 0 010-10.27zm0 1.802a3.333 3.333 0 100 6.666 3.333 3.333 0 000-6.666zm5.338-3.205a1.2 1.2 0 110 2.4 1.2 1.2 0 010-2.4z" clip-rule="evenodd" />
                                </svg>
              ...
              >
                ...
                <div class="sm:grid sm:grid-cols-3 ">
                  ...
                  >
                    ...
                    <h3 class="text-lg font-medium text-teal-50">
                      Kontakt information
                    </h3>
                    <p class="mt-6 text-base text-teal-50 max-w-3xl">
                      Kiselgatan 19 Norrköping, 60223 Sverige
                    </p>
                    <dl class="mt-8 space-y-6">
                      <dt>
                      ...
                      <dd class="flex text-base text-teal-50">
                        ...
                        <span class="ml-3">011 – 470 90 00</span>
                      </dd>
                      <dt>
                      ...
                      <dd class="flex text-base text-teal-50">
                        ...
                        <span class="ml-3">info@smartcash.se</span>
                      </dd>
                    </dl>
                    <ul role="list" class="mt-7 flex space-x-12">
                      <li>
                  ...
                  <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                    ...
                    >
                      ...
                      <div class="sm:col-span-2 sm:flex items-center sm:justify-start">
                        <button
                          type="submit"
                          class="
                            mt-2
...
const people = [
  {
    ...
    role: 'Sales',
    imageUrl:
      'https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTN8fHBlb3BsZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60',
    twitterUrl: '#',
    linkedinUrl: '#',
    mail: '@smartcash.se',
  },
  ...
  methods: {
        submitContactForm() {
            if (this.loaded) {
                ...
                axios.post('/submit-contact-form', this.fields)
                    .then(response => {
