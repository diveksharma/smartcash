                    ...
                    <div class="relative py-2 sm:overflow-hidden">
                        <div class="relative max-w-7xl mx-auto px-4 sm:py-16 -py-24 sm:px-6 lg:py-32 lg:px-auto">
                            <h1 class="lg:text-7xl text-5xl pt-16 sm:pt-0 sm:text-left font-bold text-white">
                                <span class="block leading-tight uppercase">Skönhet & Hälsa</span>
...
<!--                             <div>
            ...
            <div class="bg-purple-400 absolute right-0" style="width: 50%; height: 40%;"/>
                <div class="relative">
                    <div class="aspect-w-1 aspect-h-1 rounded-lg overflow-hidden shadow-xl">
                        <img src="https://images.unsplash.com/photo-1556740758-90de374c12ad?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" />
                    </div>

                    <div class="grid grid-cols-2 gap-4 mt-4 sm:gap-6 sm:mt-6 lg:gap-8 lg:mt-8">
                        
                        <div class="aspect-w-1 aspect-h-1 rounded-lg overflow-hidden shadow-xl">
                            <img src="https://images.unsplash.com/photo-1556740714-a8395b3bf30f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt="Photo" class="w-full h-full object-center object-cover" />
                        </div>

                        <div class="aspect-w-1 aspect-h-1 rounded-lg overflow-hidden shadow-xl">
                            <img src="https://images.unsplash.com/photo-1633526544365-a98d534c9201?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt="PC-Kassa" class="w-full h-full object-center object-cover shadow-lg" />
                        </div>
