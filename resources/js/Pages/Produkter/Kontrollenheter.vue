<template>
<Head title="Produkter - Kontrollenheter"/>
<product-layout :cart="cart">
        ...
        <div class="grid grid-cols-2 gap-y-10 sm:grid-cols-4 gap-x-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
          <Icon name="background2" class="absolute flex justify-center items-center"></Icon>  
            <Link
                v-for="product in productsKontrollenheter"
                :key="product.id"
                :href="'/produkter/kontrollenheter/' + product.slug"
            ...
            >
                ...
                >
                    ...
                    <div class="mt-2">
                        <div class="flex p-8 flex-col justify-center py-1">
                            <div class="text-sm text-center break-words font-bold">
                                {{ product.name }}
                            </div>
                            <h3 class="py-4 text-center text-xs sm:text-sm text-gray-700 truncate">
...
import Icon from '@/Components/Icon.vue'
  ...
  export default {
    props: ['products-kontrollenheter','cart'],    
    components:  {
      ProductLayout,
      Head,
      Link,
